    ...
    <section id="home" className="min-h-screen flex items-center pt-20">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div 
            ref={heroRef} 
            className="md:w-1/2 mb-10 md:mb-0 opacity-0 transition-opacity duration-1000"
          >
            <p className="text-green font-medium mb-3 animate-slide-in-left opacity-0" style={{ animationDelay: '0.3s' }}>Hello, my name is</p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4 animate-slide-in-left opacity-0" style={{ animationDelay: '0.5s' }}>
              <span className="block">[Full Name]</span>
            </h1>
            <h2 className="text-2xl md:text-3xl text-gray-600 dark:text-gray-300 mb-6 animate-slide-in-left opacity-0" style={{ animationDelay: '0.7s' }}>
              Aspiring Software Developer | Problem Solver | Tech Enthusiast
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-md mb-8 animate-slide-in-left opacity-0" style={{ animationDelay: '0.9s' }}>
            ...
            <div className="flex space-x-4 animate-slide-in-left opacity-0" style={{ animationDelay: '1.1s' }}>
          ...
          <div className="md:w-1/2 flex justify-center animate-slide-in-right opacity-0" style={{ animationDelay: '0.5s' }}>
